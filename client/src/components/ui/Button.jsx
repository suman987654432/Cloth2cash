...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-amber-400 to-amber-500 text-white hover:from-amber-500 hover:to-amber-600 focus:ring-amber-400 shadow-lg hover:shadow-xl',
